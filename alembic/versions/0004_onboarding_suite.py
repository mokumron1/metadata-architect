...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("usage_examples", _jsonb(), nullable=False, server_default="[]"),
        sa.Column("warnings", _jsonb(), nullable=False, server_default="[]"),
    ...
    op.create_table(
        ...
        sa.Column("remediation_steps", _jsonb(), nullable=False, server_default="[]"),
        sa.Column("regulatory_frameworks", _jsonb(), nullable=False, server_default="[]"),
    ...
    op.create_table(
        ...
        sa.Column("mandatory_fields", _jsonb(), nullable=False, server_default="[]"),
        ...
        sa.Column("schema_hints", _jsonb(), nullable=False, server_default="[]"),
        sa.Column("contract_yaml", sa.Text, nullable=False),
        sa.Column("contract_json", _jsonb(), nullable=False),
        sa.Column("confidence", sa.Float, nullable=False),
        sa.Column("clarification_needed", _jsonb(), nullable=False, server_default="[]"),
        sa.Column("linguistic_compliant", sa.Boolean, nullable=False, server_default="false"),
